// ── TEMA INDUSTRIAL — planta de baías · papel técnico + hazard + glass ──
...
.ind-bays{flex:1;min-width:0;display:grid;gap:clamp(8px,0.9vw,14px);grid-auto-rows:1fr}
...
.ind-bay .num{font-size:clamp(8px,0.68vw,11px);font-weight:600;letter-spacing:.3em;
  color:rgba(20,20,20,.45);text-transform:uppercase}
.ind-bay .serie{font-weight:700;font-size:clamp(15px,1.55vw,26px);letter-spacing:.02em;
  margin-top:clamp(6px,0.8vw,12px);white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
.ind-bay .modelo{font-size:clamp(9px,0.85vw,13px);color:rgba(20,20,20,.55);margin-top:2px;
  white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
.ind-bay .foot{margin-top:auto;display:flex;align-items:flex-end;justify-content:space-between;gap:6px}
.ind-bay .timer{font-weight:700;font-size:clamp(15px,1.5vw,25px);letter-spacing:.04em;
  font-variant-numeric:tabular-nums;line-height:1}
.ind-badge{font-family:'Archivo',sans-serif;font-weight:800;letter-spacing:.18em;
...
.ind-bay.free{background:
  repeating-linear-gradient(45deg,transparent 0 10px,rgba(20,20,20,.035) 10px 20px),rgba(240,238,232,.6);
  border:1px dashed rgba(20,20,20,.2)}
.ind-bay.free .disp{margin:auto;font-family:'Archivo',sans-serif;font-weight:700;
  letter-spacing:.42em;font-size:clamp(9px,0.85vw,14px);color:rgba(20,20,20,.28);text-transform:uppercase}
...
.ind-side-title{display:flex;align-items:baseline;gap:8px;
  border-bottom:2px solid #141414;padding-bottom:8px;flex-shrink:0}
.ind-side-title .t{font-family:'Archivo',sans-serif;font-weight:900;letter-spacing:.18em;
  font-size:clamp(11px,1vw,16px);text-transform:uppercase}
.ind-side-title .n{font-size:clamp(9px,0.8vw,12px);color:rgba(20,20,20,.45);font-weight:600}
.ind-side-list{flex:1;min-height:0;overflow:hidden;display:flex;flex-direction:column;margin-top:6px}
.ind-side-row{display:flex;align-items:center;gap:8px;padding:clamp(7px,0.85vw,13px) 8px;
  ...
  margin-top:5px}
.ind-side-row .arr{font-weight:700;color:rgba(20,20,20,.4);flex-shrink:0}
.ind-side-row .info{flex:1;min-width:0}
.ind-side-row .s{font-weight:700;font-size:clamp(11px,0.95vw,15px);letter-spacing:.02em;
  white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
.ind-side-row .m{font-size:clamp(8px,0.7vw,11px);color:rgba(20,20,20,.5);margin-top:1px;
  white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
.ind-side-row .d{font-weight:700;font-size:clamp(9px,0.8vw,12px);letter-spacing:.08em;flex-shrink:0}
.ind-side-row .d.hoje{color:#C8102E}
