// ─────────────────────────────────────────────────────────────────────────────
// AoVivoGlassLight — Quarta pele de UI (Apple-style, tema BRANCO com vermelho
// como cor secundária). Cópia 1:1 do AoVivoGlass em layout, dimensões, slides
// e dados; muda apenas a paleta e o blending para funcionar em fundo claro.
...
.b1 { width:clamp(400px,40vw,700px); height:clamp(400px,40vw,700px); left:-5%; top:-12%; background:radial-gradient(circle,#DC2626,transparent 62%); }
.b2 { width:clamp(380px,38vw,660px); height:clamp(380px,38vw,660px); right:-7%; top:4%; background:radial-gradient(circle,#2563EB,transparent 62%); animation-delay:-7s; }
.b3 { width:clamp(360px,36vw,620px); height:clamp(360px,36vw,620px); left:26%; bottom:-18%; background:radial-gradient(circle,#0891B2,transparent 62%); animation-delay:-13s; }
.b4 { width:clamp(280px,28vw,480px); height:clamp(280px,28vw,480px); right:16%; bottom:-12%; background:radial-gradient(circle,#DB2777,transparent 64%); animation-delay:-19s; opacity:.18; }
...
/* Ícone: logo do mascote — fundo transparente (multiply preserva contorno em fundo claro) */
...
.themebtn { background:rgba(0,0,0,.04); border:1px solid var(--stroke); border-radius:12px;
...
.rlogo { width:clamp(42px,4.5vw,60px); height:clamp(42px,4.5vw,60px); flex:none; border-radius:14px; overflow:hidden; position:relative;
  background:linear-gradient(160deg,rgba(220,38,38,0.20),rgba(220,38,38,0.10));
  border:1px solid rgba(220,38,38,0.35);
  box-shadow:0 8px 22px -8px var(--red), inset 0 1px 0 rgba(255,255,255,.7); }
.rlogo img { width:100%; height:100%; object-fit:contain;
  mix-blend-mode:multiply; filter:brightness(1.45) contrast(1.15) drop-shadow(0 0 6px rgba(220,38,38,0.4)); }
...
.rkpis > div { display:flex; flex-direction:column; gap:2px; padding:clamp(5px,0.6vw,9px) clamp(4px,0.5vw,8px); border-radius:10px;
  background:rgba(0,0,0,.04); text-align:center; min-width:0; }
...
.bdg.type { font-size:11px; font-weight:800; padding:4px 11px; letter-spacing:.1em;
  color:var(--type,var(--teal)); background:rgba(0,0,0,.04);
  border:1px solid var(--type,var(--teal)); }
.bdg.run { color:var(--green); background:rgba(22,163,74,.18); }
.bdg.run i { font-style:normal; }
.bdg.paused { color:var(--orange); background:rgba(255,159,10,.18); }
.bdg.idle { color:var(--txt2); background:rgba(0,0,0,.04); }
.bdg.prio { color:#fff; background:var(--orange); font-weight:800; }
.bdg.tier { color:var(--purple); background:rgba(124,58,237,.16); }
...
.card .timer { display:flex; align-items:baseline; justify-content:space-between; gap:8px;
  padding:clamp(6px,0.7vh,10px) clamp(8px,0.9vw,12px); border-radius:12px; background:rgba(0,0,0,.04);
...
.card .tk { display:flex; align-items:center; gap:6px; flex:none;
  font-size:clamp(11px,1vw,13px); font-weight:500; color:#1a1f2e;
  background:rgba(0,0,0,.04); padding:clamp(3px,0.4vh,5px) clamp(8px,0.9vw,11px); border-radius:8px;
...
.mini { padding:11px 13px; border-radius:16px; background:rgba(0,0,0,.04); border-left:3px solid var(--st,var(--blue)); }
...
.ntc { padding:22px 24px; display:flex; flex-direction:column; gap:14px; border:1px solid rgba(220,38,38,.3); overflow:hidden; min-height:0; }
...
.ntc .nwhy { background:rgba(220,38,38,.1); color:#7f1d1d; border-radius:14px; padding:11px 14px;
...
.ntc .ntags .t { font-size:11px; font-weight:500; padding:4px 10px; border-radius:8px; background:rgba(0,0,0,.04); color:#1a1f2e; }
...
.ntc .ntm { display:flex; align-items:center; gap:12px; padding:14px; background:rgba(220,38,38,.08); border-radius:12px; border:1px solid rgba(220,38,38,.15); }
...
.rt2 { padding:clamp(8px,0.9vh,12px) clamp(10px,1vw,16px); border-radius:14px; border-top:3px solid var(--purple); background:rgba(0,0,0,.04);
...
.rchip { padding:5px 10px; border-radius:10px; background:rgba(22,163,74,.1); border:1px solid rgba(22,163,74,.26);
...
.dc { padding:16px 20px; display:flex; flex-direction:column; gap:10px; overflow:hidden;
  border:1px solid rgba(2,132,199,.28); position:relative; }
...
.dc .bdg.type { color:var(--type,var(--sky)); background:rgba(0,0,0,.04); border:1px solid var(--type,var(--sky)); }
.dc .bdg.tier { color:var(--purple); background:rgba(124,58,237,.16); }
...
.dc .dtasks .tk { font-size:11px; font-weight:500; padding:3px 9px; border-radius:8px;
  background:rgba(2,132,199,.1); color:#0c4a6e; border:1px solid rgba(2,132,199,.22);
    ...
    <div className="ntc glass">
      ...
      <div className="ntm">
        <svg width="48" height="48" viewBox="0 0 48 48" style={{flexShrink:0}}>
          <circle cx="24" cy="24" r="22" fill="none" stroke="rgba(220,38,38,.1)" strokeWidth="2"/>
...
export default function AoVivoGlassLight({
  ...
  // Sem fit-to-screen — o #glasslight-screen agora usa 100vw/100vh directos.
  ...
  // Mapa slideId → cor de accent (tema vermelho secundário — tons quentes em destaque)
  const SLIDE_ACCENT = {
